...
<body>
    ...
    <div class="container-fluid h-100 p-5">
        ...
        <form action="add_student" method="POST" enctype="multipart/form-data" class="border shadow-lg bg-light mb-5">
            @csrf
            ...
            <div class="row w-100 mt-4">
                ...
                <div class="col-lg-6">
                    <div class="row w-100">
                        <h1 class="mr-auto ml-auto font-weight-bold p-1">Personal Details</h1>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row w-100 ml-2">
                        ...
                        <div class="row w-100">
                            <h1 class="mr-auto ml-auto font-weight-bold">Course Details</h1>
                        </div>
             ...
             <div class="row w-100 ml-2">
                ...
                <div class="col-6 text-center" style="margin-top:15%; margin-bottom:2%">
